...
class AADSSO_Settings {
	...
	*/
	 ...
	 */
	public $authorization_endpoint = 'https://login.microsoftonline.com/common/oauth2/authorize';

	/**
	 * @var string The OAuth 2.0 token endpoint.
	 */
	public $token_endpoint = 'https://login.microsoftonline.com/common/oauth2/token';
