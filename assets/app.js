"use strict";
var assets_url = $('meta[name=base_url]').attr("content");
//var plugin_path = 'assets/';
var plugin_path = assets_url+"/assets/";
...
//            var $panelClose = $(this).closest(".panel").parent();
    ...
    equal_height  : function () {
        App.includeScript(plugin_path + 'jquery-equal-height.min.js', function () {
            $('.equal_height').jQueryEqualHeight('.make_equal');
            $(window).on('resize', function () {
                setTimeout(function () {
                    $('.equal_height').jQueryEqualHeight('.make_equal');
    ...
    lazy_load     : function () {
        App.includeScript(plugin_path + 'jquery.lazy.min.js', function () {
            $('.lazy').lazy();
        });
    },
    ...
    fancy_box     : function () {
        ...
        if (_container.length > 0) {
            ...
            App.includeStyle('jquery.fancybox.min.css');
            App.includeScript('jquery.fancybox.min.js', function () {
