...
<head>
    ...
    <title>ALAR TAXI | Dashboard v1</title>
    ...
    <link href="assets/essential.css" rel="stylesheet" type="text/css">
    <link href="assets/animate.min.css" rel="stylesheet" type="text/css">       
    <link href="assets/chat.css" rel="stylesheet" type="text/css">       
...
<body class="sidebar_menu top_nav_fixed  pace-done">
                ...
                <ul class="nav navbar-nav m-l-0 pull-left">
                    <li id="minimizeSidebar" class="navbar-toggler">
                        <a href="javascript:void(0)" class="d-inline-block">
                            ...
                            <img src="assets/images/logo.png" alt="perfectin" class="w-115">
                        </a>
                    </li>
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-content">
                                ...
                                <ul class="media-list dropdown-content-body w-in-20">
                                    ...
                                    <li class="media">
                                        <div class="media-left">
                                            <img src="assets/images/pf_logo.png" class="thumbnail" alt="perfectin">
                                        </div>
                                    ...
                                    <li class="media">
                                        <div class="media-left">
                                            <img src="assets/images/svg/server.svg" class="thumbnail p-7"
                                                alt="perfectin">
                                        </div>
    ...
    <div class="ember-view" id="ember3">
        <!---->
        <div id="ember4" class="ember-view"><div class="hotline-launcher  h-open  ">
            <div class="hotline-launcher  h-open  ">
                <div class="viewport h-chat-custom h-open">
                  <div id="ember5" class="help-text fadeIn dn ember-view"><!----></div>
                  <div id="ember28" class="h-channel ember-view"><div class="h-header">
                ...
                <div class="d_hotline minimize" data-ember-action="" data-ember-action-29="29"><i class="icon icon-ic_close mild"></i></div>
            <!----></div>
            <div class="body faq-body no-articles">
              <div class="h-categories ">
                <ul>
                    <li><div id="ember31" class="channel animated fadeInLeft ember-view"><a href="/channels/11445" id="ember32" class="channel-link ember-view">  <div class="h-category-item animated fadeInRight">
                <div class="h-category-icon">
                    <img class="img-circle avatar-image" src="https://fc-use1-00-pics-bkt-00.s3.amazonaws.com/44218aff1020d0300c4e798367509bc467dcdb87c6ce08064322f3964f8cc934/f_marketingpicFull/u_fac5d6094c080bd0440c37914b328ff362987a562c4ea6a9e9f63f735cb8162b/img_1538045186264.png">
                </div>
                <div class="h-category-detail ">
                  ...
                  <h2 class="welcome-text">
                        <div class="last-msg-preview">
                          <div id="ember33" class="ember-view"><div class="h-comment  ">
            <!---->    <div id="ember34" class="ember-view">  <div class="h-message-text"><img class="emojiCe" src="https://assetscdn-wchat.freshchat.com/static/assets/images/emojis/emoji-wave.png" alt="👋">&nbsp;We're all ears for feedback. Your opinion matters to us and we'd love to hear your thoughts to make the product better.&nbsp;
            </div>
            <!----></div>
            </div></div>
                        </div>
            ...
            <!---->    </div>
                    ...
                    <li><div id="ember37" class="channel animated fadeInLeft ember-view"><a href="/channels/11371" id="ember38" class="channel-link ember-view">  <div class="h-category-item animated fadeInRight">
                <div class="h-category-icon">
                    <img class="img-circle avatar-image" src="https://fc-use1-00-pics-bkt-00.s3.amazonaws.com/44218aff1020d0300c4e798367509bc467dcdb87c6ce08064322f3964f8cc934/f_marketingpicFull/u_fac5d6094c080bd0440c37914b328ff362987a562c4ea6a9e9f63f735cb8162b/img_1538044842215.png">
                </div>
                <div class="h-category-detail ">
                  <h1 class="channel-name">
                    <!-- {{channel.name}} -->
                  ...
                  <h2 class="welcome-text">
                        <div class="last-msg-preview">
                          <div id="ember39" class="ember-view"><div class="h-comment  ">
            <!---->    <div id="ember40" class="ember-view">  <div class="h-message-text"><img class="emojiCe" src="https://assetscdn-wchat.freshchat.com/static/assets/images/emojis/emoji-raised_hands.png" alt="🙌">&nbsp;Let’s talk about your messaging needs. Ask us any product questions you have and also request for your personalized demo.
            </div>
            <!----></div>
            </div></div>
                        </div>
            ...
            <!---->    </div>
                    ...
                    <li><div id="ember43" class="channel animated fadeInLeft ember-view"><a href="/channels/11446" id="ember44" class="channel-link ember-view">  <div class="h-category-item animated fadeInRight">
                <div class="h-category-icon">
                    <img class="img-circle avatar-image" src="https://fc-use1-00-pics-bkt-00.s3.amazonaws.com/44218aff1020d0300c4e798367509bc467dcdb87c6ce08064322f3964f8cc934/f_marketingpicFull/u_fac5d6094c080bd0440c37914b328ff362987a562c4ea6a9e9f63f735cb8162b/img_1538045210779.png">
                </div>
                <div class="h-category-detail ">
                  <h1 class="channel-name">
                    <!-- {{channel.name}} -->
                  ...
                  <h2 class="welcome-text">
                        <div class="last-msg-preview">
                          <div id="ember45" class="ember-view"><div class="h-comment  ">
            <!---->    <div id="ember46" class="ember-view">  <div class="h-message-text">Reach out to us in case you have any questions on pricing and billing here.
            </div>
            <!----></div>
            </div></div>
                        </div>
            ...
            <!---->    </div>
                    ...
                    <li><div id="ember49" class="channel animated fadeInLeft ember-view"><a href="/channels/10350" id="ember50" class="channel-link ember-view">  <div class="h-category-item animated fadeInRight">
                <div class="h-category-icon">
                    <img class="img-circle avatar-image" src="https://fc-use1-00-pics-bkt-00.s3.amazonaws.com/44218aff1020d0300c4e798367509bc467dcdb87c6ce08064322f3964f8cc934/f_marketingpicFull/u_fac5d6094c080bd0440c37914b328ff362987a562c4ea6a9e9f63f735cb8162b/img_1538045150942.png">
                </div>
                <div class="h-category-detail ">
                  <h1 class="channel-name">
                    <!-- {{channel.name}} -->
                  ...
                  <h2 class="welcome-text">
                        <div class="last-msg-preview">
                          <div id="ember51" class="ember-view"><div class="h-comment  ">
            <!---->    <div id="ember52" class="ember-view">  <div class="h-message-text">Hello there!&nbsp;<img class="emojiCe" src="https://assetscdn-wchat.freshchat.com/static/assets/images/emojis/emoji-raised_hands.png" alt="🙌"> Need help? Reach out to us right here, and we'll get back to you as soon as we can!&nbsp;
            </div>
            <!----></div>
            </div></div>
                        </div>
            ...
            <div id="ember55" class="tabs dn ember-view"><!----></div>
                </div>
            </div>
        </div>
    ...
    <script src="assets/nicescroll.min.js"></script>
